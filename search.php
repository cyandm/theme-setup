...
<div class="container">
    ...
    <div id="searchPostType" class="bg-[#090C17] flex flex-row justify-between items-center p-5 rounded-3xl">
                ...
                <div class="flex items-center justify-start gap-1 py-1 px-3  border border-[#E0E0E0] rounded-full">
                    ...
                    <div>
                        <input type="text" id="search" name="s" value="<?php the_search_query() ?>"
                            class="bg-transparent text-right text-sm block w-full border-0 focus:ring-0" placeholder="جست و جو">
                    </div>
                </div>
            </div>
        </form>
