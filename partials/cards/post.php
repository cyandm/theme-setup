                ...
                <div class="relative text-white flex flex-col justify-between h-full">
                    ...
                    <div class="flex flex-col justify-between mt-6 ml-6">
                        <div class="flex flex-col justify-start items-end gap-y-4">
                            ...
                            <!-- Comments -->
                            <div class="w-[76px] h-[97px] flex flex-col justify-center items-center backdrop-blur-lg rounded-xl border border-zinc-400">
                                <form method="post" action="">
                                    <button type="submit" name="comment_post" value="<?php echo get_the_ID(); ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
