...
<div class="justify-center">
	...
	<button id="scrollToTopButton"
			class="flex flex-col justify-center items-center text-center bg-gray-900 text-white font-bold p-3 rounded-3xl shadow-lg transition duration-300">
