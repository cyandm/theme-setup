...
if ( is_null( $family_video_id ) )
	return;

?>

<div class="py-32"
	 data-element="circle-section"></div>
...
<section class="container mx-auto pt-16 flex flex-col text-center justify-center items-center">
	...
	<div class="w-full h-full rounded-lg">
		<video class="plyr_element h-full w-full rounded-lg"
			   controls
			   playsinline>

			<source src="<?php echo wp_get_attachment_url( $family_video_id ); ?>"
					type="video/mp4">
