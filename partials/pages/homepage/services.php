...
<section class="container mx-auto mt-8">
	...
	<div class="grid grid-cols-4 grid-rows-2 gap-4 mt-4 ">
		...
		<div
			 class="row-span-1 col-span-1 py-6 hover:border hover:border-cyan-500 shadow-black shadow-sm bg-white bg-opacity-5 bg-transparent backdrop-blur-md rounded-2xl flex flex-col justify-center text-center items-center">
		...
		<div
			 class="row-start-1 col-start-2 col-span-2 py-6 hover:border hover:border-cyan-500 shadow-black shadow-sm bg-white bg-opacity-5 bg-transparent backdrop-blur-md rounded-2xl flex flex-col justify-center text-center items-center">
		...
		<div
			 class="row-start-1 col-start-4 col-span-1 py-6 hover:border hover:border-cyan-500 shadow-black shadow-sm bg-white bg-opacity-5 bg-transparent backdrop-blur-md rounded-2xl flex flex-col justify-center text-center items-center">
		...
		<div
			 class="row-start-2 col-span-1 py-6 hover:border hover:border-cyan-500 shadow-black shadow-sm bg-white bg-opacity-5 bg-transparent backdrop-blur-md rounded-2xl flex flex-col justify-center text-center items-center">
		...
		<div
			 class="row-start-2 col-start-2 col-span-2 py-6 hover:border hover:border-cyan-500 shadow-black shadow-sm bg-white bg-opacity-5 bg-transparent backdrop-blur-md rounded-2xl flex flex-col justify-center text-center items-center">
		...
		<div
			 class="row-start-2 col-start-4 col-span-1 py-6 hover:border hover:border-cyan-500 shadow-black shadow-sm bg-white bg-opacity-5 bg-transparent backdrop-blur-md rounded-2xl flex flex-col justify-center text-center items-center">
