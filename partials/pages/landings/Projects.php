...
$view_all_button_url = get_field( 'view_all_button_url' ); // لینک به آرشیو پست تایپ نمونه‌کارها
	...
	<div class="flex flex-col gap-[20px] md:mx-8 mt-8">
		...
		<div class="flex flex-row justify-between">
			...
			<a href="<?php echo $view_all_button_url; ?>"
			   class="hidden md:flex border px-8 py-2 rounded-[40px]"><?php echo $view_all_button_text; ?></a>
		</div>
		...
		<swiper-container slides-per-view="auto"
						  ...
						  pagination="false"
						  navigation="false"
						  class="hidden md:flex mt-10 max-w-full md:mx-5 flex-row justify-center">
