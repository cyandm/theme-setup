(() => {
  ...
  var desktopHeaderEl = document.querySelector(".desktop-header");
  ...
  var setCssVariableGroup = () => {
    const headerHeight = desktopHeaderEl ? desktopHeaderEl.getClientRects()[0].height : 0;
  ...
  var cynDeactivate = new CustomEvent("cynDeactivate", {
    bubbles: true
  });
  ...
  function definePopUp(elem) {
    ...
    elem.addEventListener("cynActivate", () => {
      gsapWithCSS.to(backDropEl, { opacity: 1, pointerEvents: "all" });
    });
    elem.addEventListener("cynDeactivate", () => {
      gsapWithCSS.to(backDropEl, { opacity: 0, pointerEvents: "none" });
    });
  ...
  function megaMenu() {
    ...
    megaMenuItems.forEach((item) => {
      ...
      item.addEventListener("cynActivate", () => {
        gsapWithCSS.to(item, { opacity: 1, pointerEvents: "all" });
      });
      item.addEventListener("cynDeactivate", () => {
        gsapWithCSS.to(item, { opacity: 0, pointerEvents: "none" });
      });
    });
